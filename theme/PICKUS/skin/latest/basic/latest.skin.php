...
<div class="lat">
    <h2 class="lat_title">
        <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>" class="title-name"><?php echo $bo_subject ?></a>
        <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>" class="lt_more"><span class="sound_only"><?php echo $bo_subject ?></span>더보기&ensp;&ensp;+<span class="sound_only"> 더보기</span></a>
    </h2>
    <ul>
