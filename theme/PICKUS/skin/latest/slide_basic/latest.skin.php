...
<div class="pic_lt">
    ...
    <div class="swiper-container latest-slide-container">
        <div class="swiper-wrapper latest-slide-wrap">
                ...
                ?>
                <div class="item swiper-slide latest-slide-item " style=" cursor: pointer;" onclick="location.href='<?php echo $list[$i]['href'] ?>'">
        ...
        <div class="slide-control-wrap">
            <div class="swiper-pagination cs-latest-slide-pagenation"></div>
            <div class="swiper-button-next cs-latest-slide-next"></div>
            <div class="swiper-button-prev cs-latest-slide-prev"></div>
        </div>
    </div>
...
$(function(){
    var swiper = new Swiper('.swiper-container.latest-slide-container', {
        slidesPerView: 1,
        loop: true,
        loop: true,
        navigation: {
        nextEl: '.swiper-button-next.cs-latest-slide-next',
        prevEl: '.swiper-button-prev.cs-latest-slide-prev',
      },
      pagination: {
        el: '.swiper-pagination.cs-latest-slide-pagenation',
        clickable: true,
      },
      breakpoints: {
        640: {
