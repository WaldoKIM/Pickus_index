...
<div class="lat">
    ...
    <?php for ($i=0; $i<count($list); $i++) {  ?>
        <li>
            ...
            echo "<a class=\"list-link\" href=\"".$list[$i]['href']."\"><div class=\"list-tit-box\"><div class=\"list-tit\"> ";

            

            if ($list[$i]['is_notice'])
                echo "<span classs=\"latest-notice\">".$list[$i]['subject']."</span>";
            else
                echo $list[$i]['subject'];
                ...
                echo "</div>";
                echo "<span class=\"lt_date\">".$list[$i]['datetime']."</span></div>";
             echo "<div class=\"list-content\">".$list[$i]['wr_content']."</div>";
