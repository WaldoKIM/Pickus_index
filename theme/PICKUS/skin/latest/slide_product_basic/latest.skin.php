...
<div class="slide-product">
  <div class="pic_lt">
    ...
    <div class="swiper-container main-latest-slide-container">
...
<script>
  $(function () {
    var swiper = new Swiper('.swiper-container.main-latest-slide-container', {
      slidesPerView: 1,
      loop: true,
      navigation: {
        nextEl: '.swiper-button-next.latest-slide-next',
        prevEl: '.swiper-button-prev.latest-slide-prev',
      },
      pagination: {
        el: '.swiper-pagination.latest-slide-pagenation',
        clickable: true,
      },
      breakpoints: {
        640: {
