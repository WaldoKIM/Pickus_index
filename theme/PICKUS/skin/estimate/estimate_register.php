...
<script src="http://cdnjs.cloudflare.com/ajax/libs/Swiper/4.5.1/js/swiper.min.js"></script>
  ...
  <!--헤더 글자크기 충돌 방지 with KJS Dance 20220126
...
<link rel="stylesheet" type="text/css" href="/theme/PICKUS/css/estimate/estimate.css"/>
	...
	<div class="container">
		...
		<div class="options">
			...
			<ul class="container">
				<span></span>
				<li>
					<a href="./estimate_register1B.php">
...
<!-- 견적 신청 부분 아래쪽 이미지 부분 -->
		<div class="options second">
			<ul>
				...
				<li>
					<a href="/market">
						<img src="/bbs/images/main_icon_btn6_n.png">
						<div class="options_info">
							<h3>중고마켓<sup>new!</sup></h3>
