...
<style type="text/css">
	...
	#mob_view_slider li a {margin: auto; width: 100%;}

	#mob_view_slider li a img {height: auto;
	max-height: 350px;
	margin: auto;
	padding: 5%;
	}
		...
		<div id="board">
			...
			<div class="view">
				...
				<table class="web">
					...
					$cha_pick = date_diff(date_create($timenow), date_create($pickup_date));
					$cha_deac = date_diff(date_create($timenow), date_create($deadline));
					$cha_last = date_diff(date_create($deadline), date_create($pickup_date));
				...
				?>
					<div id="btn_test" class="btn_wrap">
						<ul class="row">
							<li class="co1-10">
								<a class='sub_bg_call' href='javascript:doTel("<?php echo $propose_success['mb_hp'] ?>")'>업체 연락하기 <?php echo add_hyphen($propose_success['mb_hp'])?></a> <!-- 0403 전화하기 추가-->
							</li>
						</ul>
					</div>
			...
			<div class="btn_wrap">
				<ul class="row">
					<li class="col-xs-12">
						<a class="dark_knight white" href="./my_estimate_list.php?page=<?php echo $page; ?>">목록으로 돌아가기</a>
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modal_review_content">
				<div id="board">
					...
					<div class="btn_wrap">
						<ul class="row">
							<li class="col-xs-4 col-xs-offset-4"><a class="line_bg dark_knight white" href="#" data-dismiss="modal">닫기</a></li>
						</ul>
					</div><!-- btn_wrap -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				...
				<div class="btn_wrap">
					<ul class="row">
						<li class="col-xs-3 col-xs-offset-3"><a class="line_bg dark_knight white" href="#." data-dismiss="modal">닫기</a></li>
						<li class="col-xs-3" id="confirm_before"><a class="line_bg main_bg" href="#none">확인</a></li>
						<li class="col-xs-3" id="confirm_after" style="display: none;"><a class="line_bg main_bg" href="javascript:doSelectComplete();">확인</a></li>
					</ul>
				</div>
		...
		<div class="modal-content">
			<div class="modal-body">
				...
				<div class="btn_wrap">
					<ul class="row">
						<li class="col-xs-3 col-xs-offset-3"><a class="line_bg dark_knight white" href="#." data-dismiss="modal">닫기</a></li>
						<li class="col-xs-3" id="confirm_after"><a class="line_bg main_bg" href="javascript:doSelectComplete_normal();">확인</a></li>
					</ul>
				</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="board">
					...
					<div class="btn_wrap">
						<ul class="row">
							<li class="col-xs-3 col-xs-offset-3"><a class="line_bg dark_knight white" href="javascript:doCloseReview()" data-dismiss="modal">닫기</a></li>
							<li class="col-xs-3"><a class="line_bg main_bg" href="javascript:doSaveReview()">확인</a></li>
						</ul>
					</div><!-- btn_wrap -->
...
<script type="text/javascript">
	...
	function goShopList($page, $state , $marea1, $marea2, $e_type , $memberlvl, $idx){
		var data = {
				"page" : $page,
				"state" : $state,
				"marea1" : $marea1,
