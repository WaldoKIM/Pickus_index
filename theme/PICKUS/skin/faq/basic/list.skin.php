...
<div class="intro_visual_wrap">
    <div class="intro_visual_img faq_visual_img">
        <div class="intro_visual_text">
            <h6 class="wow fadeInDown" data-wow-delay="0.5s"><?php echo $g5['title'] ?></h6>
            <p class="wow fadeInDown" data-wow-delay="0.7s">궁금한점을 찾아보세요.</p>
        </div>
    </div>
</div>


<div class="faq_wrap sub-user-wrap">
  <div class="inner">
<!-- FAQ 시작 { -->
<?php
if ($himg_src)
...
<fieldset id="faq_sch">
    ...
    <form name="faq_search_form" method="get">
        <div class="faq_search_form_box">    
            <span class="sch_tit">FAQ 검색</span>
            <input type="hidden" name="fm_id" value="<?php echo $fm_id;?>">
            <label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
            <input type="text" name="stx" value="<?php echo $stx;?>" required id="stx" class="frm_input"  maxlength="50">
