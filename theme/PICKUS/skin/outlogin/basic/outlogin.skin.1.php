...
<!--
    ...
    <fieldset>
        ...
        <div class="ol_auto_wr"> 
            ...
            <div id="ol_svc">
                <a href="<?php echo G5_BBS_URL ?>/resgister.php"><b>회원가입</b></a> /
...
-->
    ...
    <div class="user-btn-box">
        <div class="user-button login"><a href="<?php echo G5_BBS_URL ?>/login.php"> 로그인</a></div>
        <div class="user-button join"><a href="<?php echo G5_BBS_URL ?>/register.php">회원가입</a></div>
    </div>
</section>
