...
<!-- 로그인 후 아웃로그인 시작 { -->
<section id="ol_after" class="ol clearfix">
    <header id="ol_after_hd" class="clearfix">
        <h2>나의 회원정보</h2>
...
<!--            <?php echo get_member_profile_img($member['mb_id']); ?>-->
        ...
        <div class="profile_text">
           <div class="nick clearfix">
               <strong><span><?php echo $nick ?></span>님</strong>
               <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=register_form.php" id="ol_after_info" title="정보수정"><i class="fa fa-cog" aria-hidden="true"></i><span class="sound_only">정보수정</span></a>
           </div>
           <div class="user-btn-box">
                <div class="user-button">
                    <a href="<?php echo G5_BBS_URL ?>/logout.php" id="ol_after_logout" class="logout">로그아웃</a>
                    
                    </div>
                    <div class="user-button">
                    <?php if ($is_admin == 'super' || $is_auth) {  ?><a href="<?php echo G5_ADMIN_URL ?>" class="admin">관리자</a><?php }  ?>
                </div>
           </div>
        </div>
    </header>
