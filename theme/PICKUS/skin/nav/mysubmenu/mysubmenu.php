...
<div id="mysubmenu">
    ...
    <ul id="mysub<?php echo $i ?>" style="display:none;" class="tab_submenu">
        <!--<a href="<?php echo $row['me_link']; ?>" target="_<?php echo $row['me_target']; ?>" ><li class="leftmenu_b"><?php echo $row['me_name'] ?></li></a>-->
            ...
            ?>
                <li<?php if(($row2['me_name']==$board['bo_subject'])||($row2['me_name']==$g5['title'])) { echo " class=\"on_mysub\""; } ?>><a href="<?php echo $row2['me_link']; ?>" target="_<?php echo $row2['me_target']; ?>" class="leftmenuwrap hover3 on_mysuba"><?php echo $row2['me_name'] ?></a></li>
