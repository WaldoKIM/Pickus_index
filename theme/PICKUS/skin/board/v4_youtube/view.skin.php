...
if (isset($main_inc)){
    ...
    echo "<link rel='stylesheet' href='http://localhost/theme/PICKUS/skin/board/v4_youtube/magnific-popup.css'>";
    echo "<script src='http://localhost/theme/PICKUS/skin/board/v4_youtube/jquery.magnific-popup.min.js'></script>";
}
?>
    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
				<li class="board-write-btn"><a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><i class="fa fa-list" aria-hidden="true"></i><span class="board-write">목록</span></a></li>
	            <?php if ($reply_href) { ?><li class="board-write-btn"><a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i class="fa fa-reply" aria-hidden="true"></i><span class="board-write">답변</span></a></li><?php } ?>
...
<?php
        if ($view['wr_1']) { 
            echo '<div class="youtubebx"><iframe width="640" height="390" src="//www.youtube.com/embed/'.$view['wr_1'].'" frameborder="0" allowfullscreen></iframe></div>';
        } 
        ?>
