...
<section id="bo_w">
    ...
    <tr>
            <th scope="row"><label for="wr_link1">유투브URL</label></th>
            <td>
               ...
               // <!--
                ...
                <style type="text/css">
                    #desc {display:none;position:absolute;top:22px;left:0;background-color:#fff;border:1px solid #ddd;}
                </style>
                <div style="position:relative;padding-bottom:3px;">
                    <input type="button" id="showdesc" class="wz_btn_mid" value="주소 가져오는법" /> <span class="wz_desc_sm">유투브 동영상 화면에서 마우스 오른쪽 버튼클릭후 나오는 메뉴중 "동영상 URL 복사" 클릭.</span>
                    <div id="desc">
                        <img src="<?php echo $board_skin_url?>/img/youtube_desc.gif" border=0>
                    </div>
                </div>
                <input type="text" name="wr_link1" value="<?php if($w=="u"){echo$write['wr_link1'];} ?>" id="wr_link1" class="frm_input" size="50"></td>
        </tr>

        <tr>
            <th scope="row"><label for="wr_link2">링크</label></th>
            <td><input type="text" name="wr_link2" value="<?php if($w=="u"){echo$write['wr_link2'];} ?>" id="wr_link2" class="frm_input" size="50"></td>
        </tr>
