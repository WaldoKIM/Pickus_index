...
if (isset($main_inc)){
    //echo "<link rel='stylesheet' href='http://localhost/theme/PICKUS/skin/board/v4_gallery_portfolio/style.css'>";
    echo "<link rel='stylesheet' href='http://localhost/theme/PICKUS/skin/board/v4_gallery_portfolio/style_main.css'>";
    $bo_gallery_cols = 6;
}
?>
...
<div class="board_visual_wrap mainsector1">
...
<!-- 게시판 목록 시작 { -->
<div id="bo_gall" style="width:<?php echo $width; ?>" class="mainsector1">
<div class="inner">
<?php 
if (isset($main_inc)){}
else{ ?>
                    ...
                    <div class="gall_box">
                        ...
                        <div class="gall_con">
                            <div class="gall_img">
                                ...
                                <a href="<?php if (isset($main_inc)){echo $list[$i]['href_custom'];}else{echo $list[$i]['href'];} ?>">
                                    <?php
                                if ($list[$i]['is_notice']) { // 공지사항  
                                    ...
                                    if($thumb['ori']) {
                                        ...
                                        $img_content = '<div class="gallery-thumbnail" style=background-image:url("'.$thumb['ori'].'") ></div>';
                                        echo "<span class=\"is_notice\">공지</span>";
                                    } else {
                                        //  $img_content = '<span class="no_image">no image</span>';
                                        //  $img_content = '<img src="'.G5_THEME_URL.'/skin/board/gallery_table/img/no_image.png'.'" alt="'.$thumb['alt'] = '이미지가 없습니다.'.'" >';
                                  /*   $img_content = '<img src="'.$board_skin_url.'/img/no_image.png" alt="이미지가 없습니다">'; */
                                    $img_content = '<div class="gallery-thumbnail no-image" style=background-image:url("'.$board_skin_url.'/img/no_image.png") ></div>';
                                    }
                            ...
                            <div class="gall_text_area" style=" cursor: pointer;" onclick="location.href='<?php if (isset($main_inc)){echo $list[$i]['href_custom'];}else{echo $list[$i]['href'];}  ?>'">
