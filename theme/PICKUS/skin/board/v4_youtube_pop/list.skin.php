...
<div class="board_visual_wrap">
    <div class="board_visual_img board_gallery_visual_img">
        <div class="board_visual_text">
            ...
            <p class="wow fadeInDown" data-wow-delay="0.7s">유튜브형 게시판입니다.</p>
        </div>
    </div>
...
<div id="bo_gall" class="youtube_board" style="width:<?php echo $width; ?>">
    ...
    <div class="board_content_head list_tit">
        <h3 class="board_content_tit">유튜브 팝업</h3>
 ...
 <!--    <div class="bo_fx">
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>" >
            ...
            <ul class="gall_con">
                <li class="gall_href">
                    <a class="<?php echo ($is_admin ? '' : 'popup-youtube'); ?>" href="<?php echo ($is_admin ? $list[$i]['href'] : $list[$i]['wr_link1']); ?>">
                    ...
                    <?php } else {
                        ...
                        if($thumbsrc) {
                            $img_content = '<img src="'.$thumbsrc.'" alt="'.$list[$i]['subject'].'" >';
                        } else {
                ...
                <div class="gall_text_href">
                        ...
                        <?php } ?>
                        <a class="bo_tit <?php echo ($is_admin ? '' : 'popup-youtube'); ?>" href="<?php echo ($is_admin ? $list[$i]['href'] : $list[$i]['wr_link1']); ?>" >
                            <div class="gall-tit">
                           ...
                           <!--  <div class="gall_content">
                            ...
                            <div class="gall_info">
                                <span class="">조회수<?php echo $list[$i]['wr_hit'] ?> </span>
                                 <?php if ($is_good) { ?> <span class=""><span class="sound_only">추천</span><strong><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <?php echo $list[$i]['wr_good'] ?></strong></span><?php } ?>
                                 <?php if ($is_nogood) { ?><span class=""><span class="sound_only">비추천</span><strong><i class="fa fa-thumbs-o-down" aria-hidden="true"></i> <?php echo $list[$i]['wr_nogood'] ?></strong></span><?php } ?>
