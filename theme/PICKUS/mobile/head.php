       ...
       <div class="inner">
        ...
        <div class=" clearfix">
            <ul class="right_tnb">
                ...
                <li><a href="<?php echo G5_BBS_URL ?>/logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i> LOGOUT</a></li>
                <?php if ($is_admin) {  ?>
                <li class="tnb_admin"><a href="<?php echo G5_ADMIN_URL ?>"><i class="fa fa-user-circle" aria-hidden="true"></i> 관리자</a></li>
                <?php }  ?>
                <?php } else {  ?>
                <li><a href="<?php echo G5_BBS_URL ?>/register.php"><i class="fa fa-user-plus" aria-hidden="true"></i> JOIN</a></li>
                <li><a href="<?php echo G5_BBS_URL ?>/login.php"><i class="fa fa-sign-in" aria-hidden="true"></i>LOGIN</a></li>
                <?php }  ?>
            </ul>
        </div>
    </div>
