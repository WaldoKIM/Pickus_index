...
$item_cat_dtl = $item_cat_dtl_s;
if($item_cat_dtl_s == "직접입력"){
	$item_cat_dtl = $item_cat_dtl_etc;
}
if($e_type == "0"){
...
if($w == ""){
	$sql_common .= " , state = '1',
					 ...
					 writetime = now(),
					 deadline = '$deadline' ";
					 // deadline - 기존은 현재 시간에 3day를 더하는 쿼리문이였음. - Gwanghyun Kim
}
$sqlm = " insert ignore into {$g5['member_table']} set
																mb_id = '$email',
