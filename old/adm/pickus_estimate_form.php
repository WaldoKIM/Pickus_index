        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>견적마감일</th>
                    <td>
                        <input type="date" name="deadline" value="<?php echo $estimate['deadline'] ?>" id="deadline" class="frm_input" style="width:100%">
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>수거요청일</th>
                    <td>
                        <input type="date" name="pickup_date" value="<?php echo $estimate['pickup_date'] ?>" id="pickup_date" class="frm_input" style="width:100%">
                    </td>
                </tr>
            </tbody>
        </table>
                ...
                <tr>
                    ...
                    <td>
                        <div id="photoList" style="padding-bottom:5px;">
                            <input type="file" name="photo[]" class="frm_input" style="width:500px;" multiple> <p>multiple 적용하였습니다. 다중 이미지 선택 가능합니다.</p>
                        </div>
                        <!-- <a href="javascript:" class="btn btn_03 btn_add_photo">이미지 추가</a> -->
                        <?//input 하나에 이미지 여러개 등록할 수 있도록 수정하였습니다. 이미지 추가 버튼은 더 이상 필요없다고 판단하여 주석 처리하였습니다.
                          // by GwangHyun Kim ?>
                    </td>
                </tr>
            </tbody>
