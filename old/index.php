  ...
  <style type="text/css">
    ...
    @media(max-width: 768px) {
      ...
      */
      ...
      .swiper-req{width: 100%; float: none;}
...
<!-- 헤더에 다 있음   -->
  ...
  <style type="text/css">
    ...
    ul.myMenu > li ul.submenu > li { font-size : 18px !important;	}
    ul.myMenu > li ul.submenu > li > a { color: #333 !important; line-height: 20px !important;}

    @media(max-width:768px) {
      .tx {font-size : inherit !important; }
    }
  </style>
  ...
  <div id="Wrap">
    ...
    <!-- with KJS dance 광고 -->
        ...
        <!-- 광고 삭제 <div style="display:flex; justify-content:center;">
