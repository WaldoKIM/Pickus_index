        ...
        <ul class="table">
            ...
            <li class="td this_gnb">
                ...
                <div class="right_menu">
                    <ul>
                        <li>
                            <a href="http://www.repickus.com/dev/html/main/main.do" target="_blank" class="btn"><span class="txt">중고 판매 비교하기</span></a>
                        </li>
                        <li>
                            <a href="http://www.repickus.com/dev/html/estimate/registEstimate.do" target="_blank" class="btn right"><span class="txt">중고 구매 비교하기</span></a>
                        </li>
                    </ul>
                </div>
                <!-- / 오른쪽메뉴 -->
