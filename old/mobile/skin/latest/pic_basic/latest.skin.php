...
<div class="pic_lt">
    ...
    <ul>
        <li>
            <a class="lt_img" href="https://repickus.com/dev/html/estimate/estimate_registerSearch.php">
                <img src="/bbs/images/search_pick.png" alt="" width="210" height="150">
            </a>
            <a href="https://repickus.com/dev/html/estimate/estimate_registerSearch.php">
                중고 시세 조회
            </a>
        </li>  
    <?php
