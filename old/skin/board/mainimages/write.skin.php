...
<section id="bo_w">
	...
	<div class="infoTxt">
		이미지에 제목이 없을 경우 <b>제목없음</b>이라고 입력하시면 제목이 노출되지 않습니다.
	</div>
    ...
    <?php } ?>
	<div class="infoTxt">
		현재 설정된 이미지 최적 사이즈는 : 가로 <b><?php echo $board['bo_gallery_width']?></b> px /  세로 <b><?php echo $board['bo_gallery_height']?></b> px 입니다. <br>
		관리자모드 > [ <?php echo $board['bo_subject']?> ]게시판 수정 > 디자인/양식 탭 > 갤러리 이미지 폭, 갤러리 이미지 높이 에서 설정된 이미지 사이즈로 썸네일이 생성됩니다.
	</div>
