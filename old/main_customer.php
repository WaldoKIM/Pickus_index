...
function MobileCheck() { //디바이스 체크 함수
...
if (MobileCheck() == "Mobile"):
  ...
  // 함수 충돌로 2개 이상의 배너를 출력시 작동 x (리뉴얼때 개선 예정)
  echo latest('mainimages', 'mobilebn', 1, 23);

  // 모바일 견적 바로가기
  include(G5_PATH.'/components/MainPage/Estimate_Mobile.php');

  // 리뷰 (universal로 변경 예정)
  include(G5_PATH.'/components/MainPage/Review_Mobile.php');

  echo latest('mainimages', 'mobilebn1', 1, 23);

  // 앱 다운
  include(G5_PATH.'/components/MainPage/App_Down.php');
else: ?>
<!--메인배너-->
...
<div class="width50 contico">
    <ul>
        ...
        <li class="sell_06"><a href="/market">피커스 마켓<sup>new!</sup> </a></li>
    </ul>
</div>
</section>
              ...
              <div class="swiper-req" style="height: 82px; overflow: hidden;">
                <div class="list swiper-wrapper">
                  <?php for ($i = 0; $row = sql_fetch_array($fec_union); $i++) {
                    ...
                    echo "<li>" . mb_substr($row['title'], 0, 10) . "</li>";
                    echo "</ul>";
                  } ?>
