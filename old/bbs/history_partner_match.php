...
<div class="member com_pd">
	<div class="container">
		...
		<div class="sub_title">
			...
			<p class="tit_desc">내 정산내역을 확인하거나 마켓 수익금 <br class="visible-xs">출금 신청을 하실 수 있습니다.</p>
		</div>
		<div class="tab_area">
		<ul class="tab mb-5">
				<li class="col-lg-2 col-lg-offset-2 col-xs-2 col-xs-offset-2"  style="border-bottom: 1px solid #ececec  !important;">
					<a href="/bbs/history_partner.php">
						<h4>매입<span class="mnone">/철거</span></h4>
					</a>
				</li>
				<li class="col-lg-2 col-lg-offset-1 col-xs-2 col-xs-offset-1 main_bg on" style="border-bottom: 1px solid #ececec  !important;">
				...
				<table class="requst_list">
					...
					<tbody>
						...
						for ($i=0; $row=sql_fetch_array($result); $i++) {
							...
							echo "<tr>";
							echo "<td class='matitle' style='text-align:center'>".$row['title']."</td>";
