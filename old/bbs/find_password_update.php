...
$content .= '		<img class="main" src="http://www.repickus.com/dev/html/img/common/top_logo.png" alt="">';
$content .= '	</div>';
...
$content .= '			<a href="http://www.repickus.com/dev/html/" target="_black"><img class="main" src="http://www.repickus.com/dev/html/img/etc/app_icon.png" alt=""></a>';
$content .= '		</div>';
