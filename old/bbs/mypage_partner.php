...
<link rel="stylesheet" type="text/css" href="/bbs/css/mypage.css?kjs2"/>
<link rel="stylesheet" type="text/css" href="/bbs/css/mypage_partner.css?kjs2"/>
    ...
    function doSearchPost1() {
        ...
        element_wrap.style.display = 'block';
					...
					<div id="divGoodsItemList" class="form-group tab1 tab3 tabcontent current">	
						<div class="row title">
							<div class="col-xs-4 main_co full_mobile wtf">매입품목/년식 설정</div>
							<p class="col-xs-8 text-right wtf2">* 여러 품목 지정 설정이 가능합니다.</p>
						</div>
					...
					<div class="btn_wrap">
						<ul class="row">
							<li class="col-md-3 col-xs-6 col-md-offset-3"><a class="line_bg delx" href="javascript:doWithdrawal();">회원탈퇴</a></li>
							<li class="col-md-3 col-xs-6"><input class="main_bg delx" type="button" value="정보수정하기" onClick="fregisterform_submit();"></li>						
						</ul>
					</div>
				</form>
...
function doSetImage(vDiv, vComp, vTitle)
{
	if($("#"+vComp).val()){
        ...
        vHtml2 += "</a>";
        vHtml2 += "</div>";
        vHtml2 += "<img src='/data/estimate/"+$("#"+vComp).val()+"' style='width:100%; object-fit: cover;'/>";
        vHtml2 += "</div>";
