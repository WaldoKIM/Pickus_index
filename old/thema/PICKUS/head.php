...
<link rel="stylesheet" type="text/css" href="/css/menu.css?kjs4">
<link rel="stylesheet" type="text/css" href="/thema/Basic/css/style.css?220330">
<link rel="stylesheet" type="text/css" href="/thema/Basic/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="/thema/Basic/css/setting.css?kjs1">
<link rel="stylesheet" type="text/css" href="/thema/Basic/css/shop.css">
<link rel="stylesheet" type="text/css" href="/thema/Basic/css/list.css?kjs2">
...
<link rel="stylesheet" type="text/css" href="/css/modal_guide.css?kjs1"/>
...
<script src="https://kit.fontawesome.com/81fafd2ccc.js" crossorigin="anonymous"></script>
<!-- Google Tag Manager -->
<script>
    (function(w, d, s, l, i) {
        w[l] = w[l] || [];
...
.sidenav .btxi {border-bottom:none;}
 </style>
...
<div class="sidenav">
    ...
    <div class="items">
        ...
        ?>
            <div class="my main_bg">
                <h2><?php echo $member['mb_name']; ?>님!<br>환영합니다!!</h2>
            </div><!-- my -->
            <ul class="login row main_bg">
    ...
    <ul class="nav <?php if ($member['mb_level'] == 2 || $member['mb_level'] == 10) : ?>btxi<?php endif; ?> " id="nav-left">
        <?php if ($is_member) { ?>
            ...
            <?php endif; ?>
            <?php if ($member['mb_level'] == 2 || $member['mb_level'] == 10) : ?>
                                <li class=""><a class="son1" href="#" onclick="onsub1()"><span class="tx">매입&#47;철거&#160;&#160;</span><span class="subclose">▼</span></a>
                                             <a id="soff1"class="" href="#" onclick="offsub1()"><span class="tx">매입&#47;철거</span><span class="subclose cked">X</span></a>
                                    <ul class="submenu open1">
                                    <li><a href="/estimate/estimate_list2.php" class="">매입&#47;철거 전체 견적</a></li>
                                    <li><a href="/estimate/estimate_list1.php" class="">맞춤 <br class="visible-lg">추천 견적</a></li>
                                ...
                                <li><a class="son2" href="#" onclick="onsub2()"><span class="tx">바로 판매&#160;&#160;</span><span class="subclose">▼</span></a>
                                    <a id="soff2"class="" href="#" onclick="offsub2()"><span class="tx">바로 판매</span><span class="subclose cked">X</span></a>
                                    <ul class="submenu open2">
                                    <li><a href="/estimate/estimate_list3.php" class="">바로 판매 전체 견적</a></li>
                                ...
                                <li><a class="son3" href="#" onclick="onsub3()"><span class="tx">연결 내역&#160;&#160;</span><span class="subclose">▼</span></a>
                                    <a id="soff3"class="" href="#" onclick="offsub3()">연결 내역</span><span class="subclose cked">X</span></a>
                                    <ul class="submenu open3">
                                    ...
                                    <!-- <li><a href="/market/seller/order/trade.php" class="">마켓 <br class="visible-lg">고객 연결</a></li> -->
                                    <!-- <li><a href="/market/seller/order/trade.php" class="">마켓 <br class="visible-lg">고객 연결</a></li> -->
                                    </ul>
                                </li>

                                <li><a class="son4" href="#" onclick="onsub4()"><span class="tx">고객 관리&#160;&#160;</span><span class="subclose">▼</span></a>
                                    <a id="soff4"class="" href="#" onclick="offsub4()"><span class="tx">고객 관리</span><span class="subclose cked">X</span></a>
                                    <ul class="submenu open4">
                                    ...
                                    <!-- <li><a href="/market/seller/other/qna.php" class="">마켓 관련 문의&#47;후기</a></li>                                     -->
                                    </ul>
                                </li>

                                <li><a class="son5" href="#" onclick="onsub5()"><span class="tx">정산 관리&#160;&#160;</span><span class="subclose">▼</span></a>
                                    <a id="soff5"class="" href="#" onclick="offsub5()"><span class="tx">정산 관리</span><span class="subclose cked">X</span></a>
                                    <ul class="submenu open5">
                                    <li><a href="/bbs/history_partner.php" class="">매입&#47;철거 정산 내역</a></li>
                                    <li><a href="/bbs/history_partner_match.php" class="">바로 판매 정산 내역</a></li>
                                    <!-- <li><a href="/market/seller/wallet/wallet.php" class="">마켓 <br class="visible-lg">정산 내역</a></li> -->
                                    </ul>
                                </li>
                                <li><a class="" href="/market/seller/product/product_preadd.php"><span class="tx">상품 등록</span></a></li>
                                <li><a class="" href="/market/seller/product/product_list.php"><span class="tx">상품 관리</span></a></li>
                                <!-- <li><a class="" href="/market/seller/wallet/wallet_settle.php"><span class="tx">출금 신청 내역</span></a></li>
                                -->
                                <!--<li><a href="/market/index.php">피커스 마켓</a></li> -->
                            <?php endif; ?>
            <?php } else { ?>
            <?php if ($member['mb_level'] != 2) : ?>
                        ...
                        <ul style="display: flex;flex-direction: row;flex-wrap: nowrap;"class="myMenu">
                            ...
                            <?php if ($member['mb_level'] == 2 || $member['mb_level'] == 10) : ?>
                                <li><a class="btn" href="/estimate/estimate_list2.php"><span class="tx">매입&#47;철거</span></a>
                                    <ul class="submenu">
                                    <li><a href="/estimate/estimate_list2.php" class="">매입&#47;철거</br>전체 견적</a></li>
                                    <li><a href="/estimate/estimate_list1.php" class="">맞춤형</br>추천 견적</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=1" class="">매입 참여</br> 견적</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=2" class="">매입 연결</br> 견적</a></li>
                                </ul>
                                </li>
                                ...
                                <li><a class="btn" href="/estimate/partner_estimate_connect.php"><span class="tx">연결 내역</span></a>
                                    ...
                                    <li><a href="/estimate/partner_estimate_connect.php" class="">매입&#47;철거 고객 연결</a></li>
                                    <li><a href="/estimate/partner_estimate_connect.php?gubun=5" class="">바로 판매 고객 연결</a></li>
                                    <li><a href="/market/seller/order/trade.php" class="">마켓</br>고객 연결</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a class="btn" href="/market/seller/product/product_preadd.php"><span class="tx">상품 등록</span></a></li>
                                <li><a class="btn" href="/market/seller/product/product_list.php"><span class="tx">상품 관리</span></a></li>
                                <li><a class="btn" href="/market/seller/wallet/wallet_settle.php"><span class="tx">출금 신청 내역</span></a></li>
                            <?php endif; ?>
                            <?php if ($member['mb_level'] != 2) : ?>
                                <li><a href="/estimate/estimate_register.php" class="btn"><span class="tx wideletter">견적 신청</span></a>
                                <ul class="submenu">
                                ...
                                <li><a href="/market/index.php" class="btn"><span class="tx">피커스 마켓</span></a></li>
                            

                                <li><a href="/bbs/pick.php" class="btn"><span class="tx">파트너 문의</span></a></li>
                            ...
                            <?php if (($member['mb_level'] == 2) || ($member['mb_level'] == 10)) : ?>
                                <li style="display:none !important;"><a class="btn" href="http://pf.kakao.com/_qBNaxl/chat" target="_blank"><span class="tx">업체 바로문의</span></a></li>
                            <?php endif; ?>
                            <!-- <?php if ($member['mb_level'] != 2) : ?>
                    ...
                    <div class="row at-row">
                        ...
                        <script type="text/javascript">
                            ...
                            function goMove_() {
                                ...
                                var mblv = <?echo $member['mb_level'];?>;
                                console.log (mblv);

                                if ( mblv == 2 && window.location.pathname == "/estimate/my_estimate_form_match_sa.php") {
                                    window.location.href = "/estimate/partner_estimate_list.php?gubun=7";
                                }
                                else if (mblv == 2 && window.location.pathname == "/estimate/my_estimate_form.php") {
                                    window.location.href = "/estimate/partner_estimate_list.php?gubun=3";
                                }
                                else if (!mblv == 2 && window.location.pathname == "/estimate/my_estimate_form.php") {
                                    window.location.href = "/estimate/my_estimate_list.php";
                                }
                                else if (!mblv == 2 &&  window.location.pathname == "/estimate/my_estimate_form_match_sa.php") {
                                    window.location.href = "/estimate/my_estimate_list.php";
                                }
                                else if (window.location.pathname == "/market/seller/product/product_edit.php") {
                                    window.location.href = "/market/seller/product/product_list.php";
                                }
                                else if (mblv == 2 && window.location.pathname == "/market/seller/other/qna_view.php") {
                                    window.location.href = "/market/seller/other/qna.php";
                                }
                                 else if(window.location.pathname == "/bbs/login.php" || window.location.pathname == "/estimate/estimate_form.php" || 
                                 window.location.pathname == "/estimate/partner_estimate_form.php" || window.location.pathname == "/estimate/estimate_form_match.php"
                                 || window.location.pathname == "/estimate/partner_estimate_match_form.php"){
                                     window.history.back();
                                 }                                 
                                 else{
...
/* 모바일 메뉴 열고 닫기. 안타깝게도 더 나은 방안이 생각나지 않아 무식한 방법 사용. 추후 꼭 개선 부탁드립니다. with KJS dance 20220125 */
...
<script>
function myFunction() {
  alert("피커스 마켓은 2022년 2월 말 오픈됩니다! 많은 관심 부탁드립니다!");
}
</script>
