...
<? //모달 도움말 ?>
<script type="text/javascript" src="/js/modal_guide.js"></script>
...
?>
	<div class="fixbar" style="display:none">
			<div class="fixbar_flex">
				<a class="fixbar_btn" href="/estimate/partner_estimate_connect.php"><img src="../img/main_seller/list_btn_w.png" alt=""><p>연결내역</p></a>
				<!--
				<a class="fixbar_btn" href="/market/seller/product/product_preadd.php"><img src="../img/register_btn.png" alt=""><p>상품등록</p></a>
				<a class="fixbar_btn" href="/market/seller/product/product_list.php"><img src="../img/estimate_btn.png" alt=""><p>상품관리</p></a>
				-->

				<a class="fixbar_btn" href="/market/seller/product/product_preadd.php"><img src="../img/main_seller/register_btn_w.png" alt=""><p>상품등록</p></a>
				<a class="fixbar_btn" href="/market/seller/product/product_list.php"><img src="../img/main_seller/estimate_btn_w.png" alt=""><p>상품관리</p></a>	
				...
				<a class="fixbar_btn" href="/estimate/partner_estimate_list.php?gubun=3"><img src="../img/main_seller/mypage_btn_w.png" alt=""><p>고객관리</p></a>
			</div>
		</div>
<?php } ?>
...
.fixbar{
	border-top: 2px solid #1379cd !important;
	border-left: 2px solid #1379cd !important;
	border-right: 2px solid #1379cd !important;
	...
	position:fixed !important;  
 	...
 	height:10% !important; 
 	width:100% !important; 
 	background-color:#1379cd !important;
