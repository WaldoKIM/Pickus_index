...
<link rel="stylesheet" type="text/css" href="/css/my_estimate_form_match_sa.css"/>
			...
			<div class="view">
				...
				<ul class="shop_list" id="selectList">
					...
					?>
						...
						$cnt = " select count(*) as cnt from {$g5['member_table']} a left join g5_estimate_request_match b on a.mb_email = b.rc_email and b.no_estimate = '$no_estimate ' ";
						$cnt .= "where mb_show_type = 1 and mb_match = 1 and mb_id in ( select mb_id from {$g5['member_area_table']} where 1=1 and ( ( mb_area1 = '$area1' and ifnull(mb_area2,'') = '' ) or ( mb_area1 = '$area1' and mb_area2 = '$area2'))) ";
					...
					?>
					<div id="page">
						<?php echo get_paging_shop_List(G5_IS_MOBILE ? 8: 8, $page, $totalpage, $state ,  $master['area1'],  $master['area2'], $e_type , $mm['mb_level'] , $no_estimate); ?>
					</div>
				</ul>
				<?php
				if ($state == "3" || $state == "4" || $state == "5" || $state == "8" || $state == "9") {
