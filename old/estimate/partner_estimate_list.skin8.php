...
<?php //echo "<h1> 임시 타이틀 배송내역 </h1>" ?>
	<?php
		...
		echo "</div>";
		echo "<p class='onemountain'>배송중/배송완료 된 견적이 없습니다.</p>";
		echo "<p class='donde'>";
		echo "<a href='#.' data-toggle='modal' data-target='#esti_guide' class='guide_estimate'><i class='xi-help main_co'></i>&#160;이곳에서는 고객과 연결 된 후 결재까지 완료된 견적이 표시됩니다.</a></p>";
