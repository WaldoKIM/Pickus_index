...
<script language="javascript">
	...
	function reviewWriteOpen() {
		window.open("product_review_write.php?goods_idx=<?=$idx;?>", "","scrollbars=no, width=484, height=400, top=200, left=200");
	}
							...
							<table class='detail_content'>
								<tr id="detail_content">
									<td valign="top" class="prd_detail">
										...
										<a href="javascript:reviewWriteOpen();" class="order_btn2">후기작성</a>
									</td>
								</tr>
