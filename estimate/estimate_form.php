...
<link rel="stylesheet" type="text/css" href="/css/estimate_form.css"/>
...
//                                                                                 exit();
			...
			<div class="btn_wrap">
				<ul class="row">
					<li class="col-xs-12">
						<a class="dark_knight white" href="./estimate_list2.php">목록으로 돌아가기</a>
					</li>
				</ul>
			</div>
			...
			<div class="modal-body">
				...
				<div class="btn_wrap">
					...
					?>
						...
						<li class="col-xs-3"><a href="javascript:doPriceZero()" class="line_bg sub_bg">무료수거</a></li>
						<li class="col-xs-3"><a href="javascript:doNotRequest()" class="line_bg sub_bg" style="background:#da1a1a; color:#fff;">수거불가</a></li>
						<li class="col-xs-3"><a href="javascript:doSavePrice()" class="line_bg main_bg">확인</a></li>
					<?php
						}else{
							if($e_type == "1"){
                    ?>
					...
					?>
						...
						<li class="col-xs-4"><a class="line_bg dark_knight" href="#." data-dismiss="modal">닫기</a></li>
						<li class="col-xs-4"><a href="javascript:doPriceZero()" class="line_bg l_bg">무료수거</a></li>
						<li class="col-xs-4"><a href="javascript:doSavePrice()" class="line_bg main_bg">확인</a></li>
					<?php
						}
					?>
					</ul>
