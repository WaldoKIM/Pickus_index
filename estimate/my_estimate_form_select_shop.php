...
include_once('../theme/PICKUS/skin/estimate/_common.php');
	...
	echo "<p style='text-align: center; margin-bottom: 5px;'>*업체에게 문의 하여 빠른 답변을 받아보세요*</p>";
	...
	if ($_POST["state"] == "1" || $_POST["state"] == "2") {
		...
		while ($row = sql_fetch_array($request_list)) {
	...
	echo "<div id='page'>";
		echo  get_paging_shop_List(G5_IS_MOBILE ? 8: 8, $page, $totalpage, $state ,  $marea1  , $marea2 , $e_type , $memberlvl, $idx);
	echo  "</div>";
?>
